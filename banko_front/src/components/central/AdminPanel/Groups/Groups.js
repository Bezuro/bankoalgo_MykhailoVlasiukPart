...
function Groups({ graphqlService }) {
                ...
                customBodyRender: (value, tableMeta, updateValue) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <UniversalDialog data={rowData} mode="delete" />
                        </Box>
                    )
                },
            },
    ...
    const options = {
        ...
        selectableRows: 'none',
        filterType: 'checkbox',
        customToolbar: () => <UniversalDialog mode="create" />,
        setTableProps: () => {
            return {
                size: 'small',
            }
    ...
    return (
        <Container
            ...
            sx={{ minHeight: '93vh' }}
        >
            <HeadingWithButton name="Groups" />

            {data && data.groupsPopulatedAdmin.length > 0 ? (
                <MUIDataTable
                    title={'Groups List'}
                    data={data.groupsPopulatedAdmin}
                    columns={columns}
                    options={options}
                />
            ) : (
...
export default withGraphQLService()(Groups)
